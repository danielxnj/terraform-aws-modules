...
resource "aws_api_gateway_resource" "this" {
  ...
  rest_api_id = aws_api_gateway_rest_api.this[0].id
  parent_id   = each.value.parent_path_part != "/" ? try(aws_api_gateway_resource.this[each.value.parent_path_part].id) : aws_api_gateway_rest_api.this[0].root_resource_id
